...
API_ID = int(environ.get('API_ID', '21280177'))
API_HASH = environ.get('API_HASH', 'f2b74296dcf7602284ccdbc66b4f705b')
BOT_TOKEN = environ.get('BOT_TOKEN', "7535914725:AAHqFvUP1ZDC--wlaDe_rxzrkorcA7Rn8rg")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001903888279'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001903888279', '-1001914187748' '-1001547042321') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://anime:anime@cluster0.jaqb208.mongodb.net/?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
